...
<style type="text/css">
	...
	td.label { width:80px; }
	.user-content { width:560px; border:1px solid #8ED17C; align:center ; padding:25px 18px; margin-top:65px; margin-left:auto; margin-right:auto ; -moz-border-radius:5px; -webkit-border-radius:5px; }
...
<a href="/Struts2Example/jsp/Uploadfile.jsp"><img src="/Struts2Example/media/images/browse.png" /></a>
	...
	<tr>
		<td class="td-data" style="width:150px"> <s:property value="foldername" /></td>
	</tr>
	</s:iterator>

	<s:iterator value="files" >
	<tr>
		<td class="td-data" style="width:150px"> <s:property value="filename" /></td>
	</tr>
	</s:iterator>
	</table>
