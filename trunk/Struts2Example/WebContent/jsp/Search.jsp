...
.search-image{background:url(/Struts2Example/media/images/binggle.jpg) no-repeat center center;height:149px;width:265px;margin-left: auto;margin-right: auto }
...
<br><br>
<button class="searchbutton1" type="submit" value="Search">Search</button>
