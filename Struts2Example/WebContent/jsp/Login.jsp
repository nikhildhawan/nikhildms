...
<style type="text/css">
	...
	td.label { width:80px; }
	.login-box { width:380px; border:1px solid #8ED17C; align:center ; padding:25px 18px; margin-top:65px; margin-left:auto; margin-right:auto ; -moz-border-radius:5px; -webkit-border-radius:5px; }
</style>
</head>
<body>
